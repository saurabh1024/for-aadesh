...
const BuyItem = ({ Ids }) => {
    ...
    return (
        <div>
            {/* <!-- Buy item Modal --> */}
            <div className="modal fade backdrop-blur-lg buy_item" id={Ids} tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog mt-5">
                    <div className="modal-content sm:p-4">
                        <div className="modal-header">
                            ...
                            <h1 className="modal-title text-center mt-3 fs-5" id="exampleModalLabel">Buy an item</h1>
                        </div>
